...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('audit_auditlog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True)),
            ('type', self.gf('django.db.models.fields.CharField')(default='U', max_length=2)),
            ('model', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True, auto_now_add=True)),
            ('event', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('audit', ['AuditLog'])


    def backwards(self, orm):
        # Deleting model 'AuditLog'
        db.delete_table('audit_auditlog')
    ...
    models = {
        'audit.auditlog': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True', 'auto_now_add': 'True'}),
            'type': ('django.db.models.fields.CharField', [], {'default': "'U'", 'max_length': '2'}),
