...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Table'
        db.create_table('xlsx_table', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('table', self.gf('django.db.models.fields.BinaryField')()),
            ('filename', self.gf('django.db.models.fields.TextField')()),
            ('sheets', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('xlsx', ['Table'])


    def backwards(self, orm):
        # Deleting model 'Table'
        db.delete_table('xlsx_table')
