...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Workbook', fields ['owner', 'filename']
        db.create_unique('xlsx_workbook', ['owner_id', 'filename'])


    def backwards(self, orm):
        # Removing unique constraint on 'Workbook', fields ['owner', 'filename']
        db.delete_unique('xlsx_workbook', ['owner_id', 'filename'])
