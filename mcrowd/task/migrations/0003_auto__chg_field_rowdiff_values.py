...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RowDiff.values'
        db.alter_column('task_rowdiff', 'values', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'RowDiff.values'
        db.alter_column('task_rowdiff', 'values', self.gf('django.db.models.fields.TextField')(default='[]'))
    ...
    models = {
        ...
        'task.rowdiff': {
            ...
            'row': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['task.Row']", 'related_name': "'diff'"}),
